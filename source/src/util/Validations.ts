...
/** ****************************************************************************
 ***************************************************************************** */
export const validateLessThanOrLike = (
  value?: string | number,
  max?: string | number,
): boolean => {
...
/** ****************************************************************************
 ***************************************************************************** */
export const validateGreatThanOrLike = (
  value?: string | number,
  min?: string | number,
): boolean => {
...
export const validatePersonalId = (value?: string): boolean => {
  ...
  return (
    a === parseInt(text.charAt(9), 10) && b === parseInt(text.charAt(10), 10)
  );
};
...
export const validateOrganization = (value?: string): boolean => {
  ...
  return (
    text.length === 9 &&
    parseInt(text.charAt(text.length - 1), 10) ===
      mod11OfNumberWithControlDigit(text)
  );
};

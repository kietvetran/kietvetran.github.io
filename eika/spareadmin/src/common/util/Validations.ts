...
***************************************************************************** */
export const validatePersonalId = (value?: string) => {
    const text = `${value || ''}`.replace(/[\s-]+/g, '');
...
***************************************************************************** */
export const validateOrganization = (value?: string) => {
    const text = `${value || ''}`.replace(/\s+/g, '');
...
/** ****************************************************************************
***************************************************************************** */
export const validateBankRegNumber = (value?: string) => {
    const text = `${value || ''}`;
...
/** ****************************************************************************
 ***************************************************************************** */
export const validateRule = (rule='', value?: string | number): boolean => {
    let valid = true;
    value = `${value || ''}`.trim();
    if ( rule === Constant.validationRequired ) {
        valid = !!value;
    } else if ( rule === Constant.validationMobile ) {
        valid = validateMobile(value);
    } else if ( rule === Constant.validationPersonId ) {
        valid = validatePersonalId( value );
    } else if ( rule === Constant.validationEmail ) {
        valid = validateEmail(value);
    } else if ( rule === Constant.validationPassword ) {
        valid = validatePassword(value);
    } else if ( rule === Constant.validationBankRegNumber ) {
        valid = validateBankRegNumber(value);
    } else if ( rule === Constant.validationOrganizationNumber ) {
        valid = validateOrganization(value);
    } else if ( rule === Constant.validationPersonIdOrOrganizationNumber ) {
        valid = validateOrganization(value) || validatePersonalId( value );
    } 

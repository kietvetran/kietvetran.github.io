...
import {SkyPig} from '../common/SkyPig/SkyPig';
      ...
      <ul className="application-list">
        <li className="application-item">
          <div style={{position: 'relative', margin: '0 0 10px 0'}}>
            <input id="checkbox-pig" type="checkbox" className="input-checkbox" checked={this.state.pig} onChange={() =>{
              this.setState({ pig: !this.state.pig});
            }}/>
            <label htmlFor="checkbox-pig">Automatisk øking spareavtale</label>
          </div>

          <SkyPig on={this.state.pig} />
        </li>
        { 
        /*
        <li className="application-item">
           <Chart data={[
              ...
              {'value': 65, 'step': false, 'track': false}so
